...
```javascript
import data from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-data-buffer@v0.1.0-deno/mod.js';
```
...
[@stdlib/ndarray/base/buffer]: https://github.com/stdlib-js/stdlib/tree/deno
